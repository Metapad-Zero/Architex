 ...
 * liquidity that only buys the token, below the market, that nobody can withdraw (the hook's bidCount counts them). On
 * the curve the launchpad holds it, and graduation places it as the pool's first bid.
 */
