  ...
  return (
    <div className="space-y-4">
      ...
      <p>
        ...
        Distribute to holders, a Combo of those, or any address you paste. The builder checks a
        plugin's settings the way the plugin itself will, so a Split with a duplicate payee or a
